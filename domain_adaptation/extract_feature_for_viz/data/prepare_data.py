...
def generate_dataloader(args):
    # Data loading code
    traindir = args.source_data_path
    valdir = args.target_data_path
    if not os.path.isdir(traindir):
        # split_train_test_images(args.data_path)
        raise ValueError('Null path of training data!!!')
    ...
    train_loader = torch.utils.data.DataLoader(
        train_dataset, batch_size=args.batch_size_s, shuffle=False,
