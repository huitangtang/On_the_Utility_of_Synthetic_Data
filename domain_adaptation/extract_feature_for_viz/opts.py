...
def opts():
    parser = argparse.ArgumentParser(description='No Adaptation', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    parser.add_argument('--decay_epoch', type=int, nargs='+', default=[8, 12], 
    ...
    parser.add_argument('--no_pretrained', dest='pretrained', action='store_false', help='Whether using pre-trained model.')
