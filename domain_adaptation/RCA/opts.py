...
def opts():
    parser = argparse.ArgumentParser(description='RCA', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    # Dataset options
    ...
    parser.add_argument('--em', action='store_true', help='Whether to use entropy minimization.')
    parser.add_argument('--seed', type=int, default=0, help='random seed')
    # VAT
    parser.add_argument('--vat', action='store_true', help='Whether to use virtual adversarial training.')
    parser.add_argument('--xi', type=float, default=1e-6, metavar='XI', help='Hyperparameter of VAT (default: 1e-6).')
    parser.add_argument('--eps_vat', type=float, default=0.1, metavar='EPS_VAT', help='Hyperparameter of VAT (default: 0.1).')
